...
io_arxml.ref(('Implementations', 'HWIO')).default.resource_consumption = autosar.ResourceConsumption(
    short_name=autosar.Identifier(value='resourceConsumption'))
io_arxml.ref(('Implementations', 'HWIO', 'src')).default.artifact_descriptors = autosar.Code.ArtifactDescriptors(
    autosar_engineering_object=[autosar.AutosarEngineeringObject()])
io_arxml.ref(('InterfaceTypes', 'HWIOInput', 'Read', 'Value')).default.type_tref.value = '/ImplementationTypes/SInt32'
