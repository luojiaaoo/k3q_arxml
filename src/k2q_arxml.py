...
class AutosarParam:
    ...
    def init(cls, autosar_version):
        ...
        autosar = importlib.import_module(
            f"pyarxml.autosar.{autosar_version}.{autosar_version}"
        )
...
class Arxml:
    ...
    @staticmethod
    def get_ar_package(
        obj: Union[autosar.Autosar, autosar.ArPackage], short_name: str
    ) -> Optional[autosar.ArPackage]:
    ...
    @classmethod
    def get_dict_ref_obj(
        cls, obj, ref=None, dict_top: Dict = None
    ) -> Dict[str, dataclass]:
        if dict_top is None:
            dict_top = {}
        if ref is None:
    ...
    @classmethod
    def retrieve_obj_based_on_ref_str(
        cls, dict_ref: Dict[str, dataclass], ref_str: str
    ) -> Optional[dataclass]:
